...
const calculateMinRelevance = (level, unit) => {
...
const addRelevanceRequirements = (lessons, unit) => {
...
const addCharismaRequirements = (lessons, unit) => {
    if (unit !== 5) {
...
export const findLesson = (unitId, levelId) => {
