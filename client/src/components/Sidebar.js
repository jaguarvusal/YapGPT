...
const Sidebar = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "mt-1", children: _jsx("div", { className: "flex items-center justify-center", children: _jsx("img", { src: "/assets/logo.png", alt: "YapGPT Logo", className: "w-40 h-40" }) }) }), _jsx("div", { className: "mt-10", children: _jsxs("div", { className: "flex flex-col w-full", children: [_jsx("div", { className: "mb-4 w-full", children: _jsx("button", { className: `w-[90%] rounded-xl transition-all duration-150 group ${selectedButton === 'yap'
                                    ? 'bg-[#f3e0b7] border-2 border-[#e15831]'
                                    : ''}`, "aria-label": "Yap", onClick: () => handleNavigation('/', 'yap'), children: _jsxs("div", { className: `flex items-center space-x-4 text-2xl px-2 py-3 rounded-xl ${selectedButton !== 'yap' ? 'group-hover:bg-[#f3e0b7]' : ''}`, children: [_jsx("span", { className: "w-16 h-16", children: _jsx("img", { src: "/assets/yap.png", alt: "Yap", className: "w-full h-full object-contain" }) }), _jsx("span", { className: `text-sm font-medium ${selectedButton === 'yap'
                                                ? 'text-[#e15831]'
                                    ...
                                    ? 'bg-[#f3e0b7] border-2 border-[#e15831]'
                                    : ''}`, "aria-label": "Leaderboard", onClick: () => handleNavigation('/leaderboards', 'leaderboard'), children: _jsxs("div", { className: `flex items-center space-x-4 text-2xl px-2 py-3 rounded-xl ${selectedButton !== 'leaderboard' ? 'group-hover:bg-[#f3e0b7]' : ''}`, children: [_jsx("span", { className: "w-16 h-16", children: _jsx("img", { src: "/assets/leaderboards.png", alt: "Leaderboard", className: "w-full h-full object-contain" }) }), _jsx("span", { className: `text-sm font-medium ${selectedButton === 'leaderboard'
                                                ? 'text-[#e15831]'
                                    ...
                                    ? 'bg-[#f3e0b7] border-2 border-[#e15831]'
                                    : ''}`, "aria-label": "Flirt", onClick: () => handleNavigation('/flirt', 'flirt'), children: _jsxs("div", { className: `flex items-center space-x-4 text-2xl px-2 py-3 rounded-xl ${selectedButton !== 'flirt' ? 'group-hover:bg-[#f3e0b7]' : ''}`, children: [_jsx("span", { className: "w-16 h-16", children: _jsx("img", { src: "/assets/flirt.png", alt: "Flirt", className: "w-full h-full object-contain" }) }), _jsx("span", { className: `text-sm font-medium ${selectedButton === 'flirt'
                                                ? 'text-[#e15831]'
